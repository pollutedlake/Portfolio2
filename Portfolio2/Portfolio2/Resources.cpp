...
HRESULT Resources::init(void)
{
	...
	IMAGEMANAGER->addImage("¾øÀ½", "Resources/Images/UI/Shop/¾øÀ½.bmp", 24, 24);
	...
	IMAGEMANAGER->addImage("°Ë»ç¿ëBattleSceneBG1", "Resources/Images/BackGrounds/BattleScene/°Ë»ç¿ëBattleSceneBG1.bmp", 1200, 1920);
	...
	IMAGEMANAGER->addImage("´Ù¸¶½ºÄ¿½º", "Resources/Images/UI/Shop/´Ù¸¶½ºÄ¿½º.bmp", 24, 24);
	IMAGEMANAGER->addImage("¹æÅºº¹", "Resources/Images/UI/Shop/¹æÅºº¹.bmp", 24, 24);
	IMAGEMANAGER->addImage("½ºÇÇµå ½´Áî", "Resources/Images/UI/Shop/½ºÇÇµå ½´Áî.bmp", 24, 24);
