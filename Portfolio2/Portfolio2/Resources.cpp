...
HRESULT Resources::init(void)
{
	...
	IMAGEMANAGER->addImage("ÀÚ¸¶µå ¾Æ±×´Ï", "Resources/Images/UI/Shop/ÀÚ¸¶µå ¾Æ±×´Ï.bmp", 24, 24);
	IMAGEMANAGER->addImage("ºê¸®Æ®¶ó", "Resources/Images/UI/Shop/ºê¸®Æ®¶ó.bmp", 24, 24);
	IMAGEMANAGER->addImage("µ¹°Ý¼ÒÃÑ", "Resources/Images/UI/Shop/µ¹°Ý¼ÒÃÑ.bmp", 24, 24);
	IMAGEMANAGER->addImage("½º³ªÀÌÆÛ °Ç", "Resources/Images/UI/Shop/½º³ªÀÌÆÛ °Ç.bmp", 24, 24);
	IMAGEMANAGER->addImage("Å×½´ºê", "Resources/Images/UI/Shop/Å×½´ºê.bmp", 24, 24);
	IMAGEMANAGER->addImage("º®·Â±Ã", "Resources/Images/UI/Shop/º®·Â±Ã.bmp", 24, 24);
	...
	IMAGEMANAGER->addImage("LoadingScene4", "Resources/Images/BackGrounds/LoadingScene/LoadingScene4.bmp", 400, 200);
	IMAGEMANAGER->addImage("LoadingScene5", "Resources/Images/BackGrounds/LoadingScene/LoadingScene5.bmp", 400, 200);
	IMAGEMANAGER->addImage("LoadingScene6", "Resources/Images/BackGrounds/LoadingScene/LoadingScene6.bmp", 400, 200);
	IMAGEMANAGER->addImage("LoadingScene7", "Resources/Images/BackGrounds/LoadingScene/LoadingScene7.bmp", 400, 200);
	IMAGEMANAGER->addImage("LoadingScene8", "Resources/Images/BackGrounds/LoadingScene/LoadingScene8.bmp", 400, 200);
	IMAGEMANAGER->addImage("LoadingScene9", "Resources/Images/BackGrounds/LoadingScene/LoadingScene9.bmp", 400, 200);
	IMAGEMANAGER->addImage("LoadingScene10", "Resources/Images/BackGrounds/LoadingScene/LoadingScene10.bmp", 400, 200);
	IMAGEMANAGER->addImage("LoadingScene11", "Resources/Images/BackGrounds/LoadingScene/LoadingScene11.bmp", 400, 200);
